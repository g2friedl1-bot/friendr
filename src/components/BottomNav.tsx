...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-zinc-950/95 backdrop-blur-md border-t border-zinc-800/70">
      {expanded && (
        <>
          ...
          <div className="flex flex-wrap justify-center gap-2.5 px-4 py-3 border-b border-zinc-800/60">
            ...
            <Link href="/find" onClick={() => setExpanded(false)}
              className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-zinc-700 hover:bg-zinc-600 text-white font-semibold transition-all text-sm shadow-md">
      ...
      <div className="flex items-center justify-between px-6 py-3 max-w-lg mx-auto">
        ...
        <Link href="/chats" className="flex flex-col items-center gap-1 text-zinc-500 hover:text-white transition-colors">
        ...
        <Link href="/profile" className="flex flex-col items-center gap-1 text-zinc-500 hover:text-white transition-colors">
          <UserCircle className="w-5 h-5" strokeWidth={2} />
          <span className="text-xs">Profile</span>
        </Link>

        <Link href="/settings" className="flex flex-col items-center gap-1 text-zinc-500 hover:text-white transition-colors">
